...
class MenuCategoryResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Меню категория';

    protected static ?string $modelLabel = 'Меню категория';

    protected static ?string $pluralModelLabel = 'Меню категория';
